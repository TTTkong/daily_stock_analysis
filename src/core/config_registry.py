...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EASTMONEY_NEWS_ENABLED": {
        "title": "EastMoney Free News",
        "description": "Enable EastMoney free news source (stock news + 7x24 global feed). Zero API key, zero cost. Disable only if you prefer paid search APIs.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
